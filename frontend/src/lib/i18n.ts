...
const en = {
  ...
  "dlg.unshare": "Unshare",
  "dlg.unshareBlocked": "Archived chats stay public — unarchive first to remove the link.",
  ...
  "admin.resetLink": "Email a password reset link",
  "admin.regenTitle": "Regenerate the key for @{user}?",
  "admin.regenMsg": "Their sessions will be revoked immediately and the new key is shown only once — make sure you can reach them.",
  "admin.regenConfirm": "Regenerate",
  "admin.resetTitle": "Email a reset link to @{user}?",
  "admin.resetMsg": "A one-time key-recovery link will be sent to {email}.",
  "admin.resetConfirm": "Send link",
  "admin.resetSent": "Reset link sent to @{user} ({email}).",
  "admin.resetFailed": "Could not send the reset link",
  ...
  "voice.engineAuto": "Auto (neural if available)",
  "voice.engineBrowser": "Browser speech",
  "voice.engineServer": "Neural server voice",
  "voice.engineHintOn": "Neural TTS via {provider}",
  "voice.engineHintOff": "No neural provider configured — browser speech only",
  "voice.serverVoice": "Neural voice",
  "voice.serverVoiceHint": "ElevenLabs voice id",
  "voice.piperNote": "Local piper voice (single configured model).",
  "voice.noServer": "Configure ELEVENLABS_API_KEY, OPENAI_API_KEY or piper to unlock neural voices.",
